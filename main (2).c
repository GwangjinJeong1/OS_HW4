...
/* changed this function to the one above for better efficiency, feel free to change it or dedlete it if
you guys prefer to use the other one or the new one gives problems, delete the one 
i wrote :)
